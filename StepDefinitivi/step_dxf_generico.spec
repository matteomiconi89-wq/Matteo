...
_ez_datas, _ez_bin, _ez_hidden = collect_all('ezdxf')

a = Analysis(
    ['step_dxf_generico.py'],
    pathex=[r'C:\Users\User\Desktop\CLAUDE\ConfrontoProgrammi',
            ...
            r'C:\Users\User\Desktop\CLAUDE\Viste',
            r'C:\Users\User\Desktop\CLAUDE\Definitivi'],
    binaries=_ez_bin,
    datas=_ez_datas,
    hiddenimports=_ez_hidden + ['acis_topo', 'confronta_file_unici_dxf', 'genera_sezionatura_cp_21032',
                   'file_unici_dxf_generico', 'dxf2tlf_masterwood',
                   'dxf2mpr_homag', 'inietta_3d', 'scheda_pdf',
