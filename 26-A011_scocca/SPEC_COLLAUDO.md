...
| Manus giro 1 (82 cr) | ✓ **collaudato** | scena madre vuota `master_stage_open_empty.png` 2400×1350, task `WSLtwCSEyoi5azfnCcFKP5`; Manus ha costruito la scena in Blender (`.blend` riusabile) e riporta camera/VP/quote esatte. Collaudo mio sui pixel: parete di fondo **430 px centrata a x=1199** (teoria 429 @ x=1200) ✓; dimensioni file esatte ✓; conteggi (2 gradini, 4 oblò) dichiarati da Manus, da confermare a occhio da Matteo sui link. 7 allegati consegnati (5 tavole GitHub raw + 2 scene Dropbox monouso) |
| Manus giro 2 (88 cr) | ✓ **collaudato, in attesa occhio Matteo** | `master_stage_kitchen_right_closed.png`: cucina v10 chiusa nella baia destra X 4.407→8.291. Collaudo mio sui pixel: parete fondo identica al giro 1 (bordi 984/1414) ✓; **metà sinistra identica al giro 1 (diff media 0,04/255)** = anti-regressione perfetta ✓; zona cucina cambiata (diff 5,2, dettaglio +38%) = cucina presente ✓. Auto-collaudo Manus tutto pass: 4 frontali, 2 colonne+dispensa, 4 ribalte, stacco soffitto 78–126, VP (1200,675), baia sx vuota. **Residuo dichiarato**: larghezze moduli ridistribuite (frigo 700 vs 610 di spec, basi 571 vs ~588, totale 3.884 esatto) — fuori slop ±10% solo il frigo; eventualmente giro 3 single-fix. Totale task: 170 cr |
